...
SECRET_KEY = 'django-insecure-5q@*f51(0y4jsq2m9=3vt+lv9l0*=m7lhfzt*ua1=e%f8+vwnu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
# mylinebot-4fbee.firebaseapp.com
ALLOWED_HOSTS = ['mylinebot-4fbee.firebaseapp.com','mylinebot-4fbee.web.app','127.0.0.1','6e92-2001-b011-c040-3a05-8516-dfc9-d157-c78f.jp.ngrok.io'] # ngrok http 8000
...
INSTALLED_APPS = [
    ...
    'loaninglinebot.apps.LoaninglinebotConfig',
]
